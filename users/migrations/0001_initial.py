    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Élève'), ('teacher', 'Enseignant'), ('parent', 'Parent'), ('admin', 'Administrateur')], default='student', max_length=20, verbose_name="Type d'utilisateur")),
                ('level', models.CharField(blank=True, choices=[('cp1', 'CP1'), ('cp2', 'CP2'), ('ce1', 'CE1'), ('ce2', 'CE2'), ('cm1', 'CM1'), ('cm2', 'CM2'), ('sixieme', '6ème'), ('cinquieme', '5ème'), ('quatrieme', '4ème'), ('troisieme', '3ème'), ('seconde', 'Seconde'), ('premiere', 'Première'), ('terminale', 'Terminale')], max_length=20, null=True, verbose_name='Niveau scolaire')),
                ...
                ('is_active_student', models.BooleanField(default=True, verbose_name='Élève actif')),
